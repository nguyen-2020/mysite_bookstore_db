...
class Order(models.Model):
    ...
    shippingaddress = models.CharField(db_column='ShippingAddress', max_length=255)  # Field name made lowercase.
    recipientname = models.CharField(db_column='RecipientName', max_length=255)  # Field name made lowercase.
    recipientphone = models.CharField(db_column='RecipientPhone', max_length=255)  # Field name made lowercase.
...
class Orderdetail(models.Model):
    ...
    reviewstatus = models.CharField(db_column='ReviewStatus', max_length=9)  # Field name made lowercase.
